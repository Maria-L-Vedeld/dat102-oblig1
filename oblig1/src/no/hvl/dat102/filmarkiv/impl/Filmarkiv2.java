...
public class Filmarkiv2 implements FilmarkivADT {
    ...
    public Film[] sokTittel(String delstreng) {
        return soek(film -> film.getTittel().toLowerCase().contains(delstreng.toLowerCase()));
    }

    @Override
    public Film[] sokFilmskaper(String delstreng) {
        return soek(film -> film.getFilmskaper().toLowerCase().contains(delstreng.toLowerCase()));
    }

    private Film[] soek(java.util.function.Predicate<Film> kriterie) {
